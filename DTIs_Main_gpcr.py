...
def main():
    ...
    # 1-Random Forest
    rf = RandomForestClassifier(n_estimators=200 ,n_jobs=10,random_state= 55,  criterion='gini') 
    ...
    ab = AdaBoostClassifier(DecisionTreeClassifier(criterion='gini', splitter='best', max_depth=6, min_samples_split=2,
                        ...
                        max_leaf_nodes=None, min_impurity_split=None), algorithm="SAMME", n_estimators=100, random_state=32)
    ...
    ### Build feature vector and class labels
        ...
        utils.outputCSVfile('featuregpcr.csv',XX)
